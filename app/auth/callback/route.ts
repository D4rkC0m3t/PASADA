        ...
        if (!profile) {
          ...
          if (type === 'client') {
            const { data: clientData } = await supabase
              ...
              .insert({
                ...
                contact_name: session.user.user_metadata?.full_name || session.user.user_metadata?.name || session.user.email,
          ...
          await supabase
            ...
            .insert({
              ...
              client_id: clientId, // Link to client record if created
              is_active: true
            })
        } else {
